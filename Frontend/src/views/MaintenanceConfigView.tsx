...
export const MaintenanceConfigView: React.FC<MaintenanceConfigViewProps> = ({
  ...
  const handleSaveConfig = () => {
    setIsSaving(true);
    setTimeout(() => {
      const saved = saveMaintenanceSettings(formData, userName);
      setIsSaving(false);
      setFormData(saved);
      showAlert(
        'success',
        'Konfigurasi Disimpan!',
        'Pengaturan Maintenance Mode berhasil diperbarui dan disinkronkan dengan database.'
      );
    }, 400);
  };
    ...
    showAlert(
      ...
      () => {
        ...
        showAlert(
          ...
          'Aplikasi kini dalam mode pemeliharaan. Hanya Administrator yang dapat mengakses sistem.'
        );
      },
      true,
    ...
    showAlert(
      ...
      () => {
        ...
        showAlert(
          ...
          'Maintenance Mode berhasil dimatikan. Seluruh pengguna dapat kembali mengakses aplikasi.'
        );
      },
      true,
      ...
      {isPreviewModalOpen && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <MaintenancePage
            ...
            onAdminLoginClick={() => {
              showAlert('info', 'Login Admin', 'Menu login admin diakses untuk verifikasi bypass.');
            }}
            isPreview={true}
