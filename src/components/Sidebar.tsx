...
import { 
  ...
  Database, Layers, ShieldCheck, X, ChevronRight, TrendingUp, Wrench, KeyRound
} from 'lucide-react';
  ...
  if (isAdmin) {
    menuGroups.push({
      ...
      items: [
        ...
        { id: 'password-reset-requests', label: 'Reset Password', icon: <KeyRound className="w-4 h-4 text-amber-400" /> },
